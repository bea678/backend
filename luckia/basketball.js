...
export async function scrapeLuckiaBasketball() {
    ...
    try {
        console.log('📡 [LUCKIA BALONCESTO] Verificando IP de salida...');
        try {
            ...
            console.log(`🌍 [LUCKIA BALONCESTO] IP Confirmada: ${myIp}`);
        } catch (e) {
            console.log('⚠️ [LUCKIA BALONCESTO] No se pudo verificar la IP...');
        }
        ...
        for (let i = 0; i < maxScrolls; i++) {
            try {
                ...
                if (botonClicado) {
                    console.log(`   🔄 [LUCKIA BALONCESTO] Clic en "Ver más" (Iteración ${i + 1})`);
