...
// --- FUNCIÓN PRINCIPAL ---
export async function scrapeBwinFootball(browserParam) {    
    ...
    try {
        ...
        await page.goto('https://www.bwin.es/es/sports/f%C3%BAtbol-4/hoy', { waitUntil: 'domcontentloaded', timeout: 80000 });
